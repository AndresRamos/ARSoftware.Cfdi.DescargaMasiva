...
{
    public interface ISolicitudDescargaEmitidosService
    {
        /// <summary>
        ...
        string GenerateSoapRequestEnvelopeXmlContent(SolicitudDescargaEmitidosRequest solicitudRequest, X509Certificate2 certificate);
        ...
        Task<SolicitudDescargaEmitidosResult> SendSoapRequestAsync(SolicitudDescargaEmitidosRequest solicitudRequest,
        ...
        SolicitudDescargaEmitidosResult GetSoapResponseResult(SoapRequestResult soapRequestResult);
    }
}
