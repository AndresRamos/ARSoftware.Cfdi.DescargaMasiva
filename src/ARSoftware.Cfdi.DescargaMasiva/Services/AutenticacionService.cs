...
namespace ARSoftware.Cfdi.DescargaMasiva.Services
{
    public sealed class AutenticacionService : IAutenticacionService
    {
        ...
        public string GenerateSoapRequestEnvelopeXmlContent(AutenticacionRequest autenticacionRequest, X509Certificate2 certificate)
        {
            ...
            XmlElement securityElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WssePrefix, "Security",
            ...
            XmlElement timestampElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WsuPrefix, "Timestamp",
            ...
            XmlElement createdElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WsuPrefix, "Created",
                CfdiDescargaMasivaNamespaces.WsuNamespaceUrl);
            ...
            XmlElement expiresElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WsuPrefix, "Expires",
                CfdiDescargaMasivaNamespaces.WsuNamespaceUrl);
            ...
            XmlElement binarySecurityTokenElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WssePrefix,
                "BinarySecurityToken", CfdiDescargaMasivaNamespaces.WsseNamespaceUrl);
            binarySecurityTokenElement.SetAttribute("Id", CfdiDescargaMasivaNamespaces.WsuNamespaceUrl,
            ...
            XmlElement securityTokenReferenceElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WssePrefix,
                "SecurityTokenReference", CfdiDescargaMasivaNamespaces.WsseNamespaceUrl);
            XmlElement securityTokenReferenceReferenceElement = xmlDocument.CreateElement(CfdiDescargaMasivaNamespaces.WssePrefix,
                "Reference", CfdiDescargaMasivaNamespaces.WsseNamespaceUrl);
        ...
        {
            return await _httpSoapClient.SendRequestAsync(CfdiDescargaMasivaWebServiceUrls.Autenticacion,
                DescargaMasivaSoapActionUrls.Autentica, AccessToken.CreateEmpty(), soapRequestContent, cancellationToken);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            SoapRequestResult soapRequestResult = await _httpSoapClient.SendRequestAsync(CfdiDescargaMasivaWebServiceUrls.Autenticacion,
                DescargaMasivaSoapActionUrls.Autentica, AccessToken.CreateEmpty(), soapRequestContent, cancellationToken);
        ...
        public AutenticacionResult GetSoapResponseResult(SoapRequestResult soapRequestResult)
        {
            ...
            return AutenticacionResult.CreateFailure(faultCode, faultString, soapRequestResult.HttpStatusCode,
                soapRequestResult.ResponseContent);
        }
    }
}
