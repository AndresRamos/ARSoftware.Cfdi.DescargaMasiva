    ...
    public sealed class SolicitudDescargaFolioService : ISolicitudDescargaFolioService
    {
            ...
            CancellationToken cancellationToken)
        {
            return await _httpSoapClient.SendRequestAsync(CfdiDescargaMasivaWebServiceUrls.SolicitaDescargaService,
                DescargaMasivaSoapActionUrls.SolicitaDescargaFolio, accessToken, soapRequestContent, cancellationToken);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            SoapRequestResult soapRequestResult = await _httpSoapClient.SendRequestAsync(
                CfdiDescargaMasivaWebServiceUrls.SolicitaDescargaService, DescargaMasivaSoapActionUrls.SolicitaDescargaFolio,
        ...
        public SolicitudDescargaFolioResult GetSoapResponseResult(SoapRequestResult soapRequestResult)
        {
            ...
            return new SolicitudDescargaFolioResult(idSolicitud, rfcSolicitante, codEstatus, mensaje, soapRequestResult.HttpStatusCode,
                soapRequestResult.ResponseContent);
        }
    }
}
