...
public sealed class EstadoComprobante : SmartEnum<EstadoComprobante, int>
{
    ...
    ///     Null
    /// </summary>
    public static readonly EstadoComprobante Null = new("Null", -1);

    /// <summary>
    ///     Cancelado = 0
    /// </summary>
    public static readonly EstadoComprobante Cancelado = new("Cancelado", 0);

    /// <summary>
    ///     Vigente = 1
    /// </summary>
    public static readonly EstadoComprobante Vigente = new("Vigente", 1);
