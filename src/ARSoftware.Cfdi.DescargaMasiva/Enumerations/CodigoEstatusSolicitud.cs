...
namespace ARSoftware.Cfdi.DescargaMasiva.Enumerations
{
    ...
    public sealed class CodigoEstatusSolicitud : SmartEnum<CodigoEstatusSolicitud>
    {
        ...
        ///     301 = XML Mal Formado
        /// </summary>
        public static readonly CodigoEstatusSolicitud _301 = new("301", 301, "XML Mal Formado",
        ...
        /// </summary>
        public static readonly CodigoEstatusSolicitud _303 = new("303", 303,
            "Sello no corresponde con RfcEmisor, RfcReceptor, o RfcSolicitante", "");

        /// <summary>
        ///     304 = Certificado Revocado o Caduco
        /// </summary>
        public static readonly CodigoEstatusSolicitud _304 = new("304", 304, "Certificado Revocado o Caduco",
            "El certificado puede ser invalido por múltiples razones como son el tipo, la vigencia, etc.");

        /// <summary>
        ///     305 = Certificado Inválido
        /// </summary>
        public static readonly CodigoEstatusSolicitud _305 = new("305", 305, "Certificado Inválido",
            "El certificado puede ser invalido por múltiples razones como son el tipo, la vigencia, etc.");

        /// <summary>
        ///     404 = Error no Controlado
        /// </summary>
        public static readonly CodigoEstatusSolicitud _404 = new("404", 404, "Error no Controlado",
        ...
        /// </summary>
        public static readonly CodigoEstatusSolicitud _5001 = new("5001", 5001, "Tercero no autorizado",
            "Se da cuando se trata de descargar comprobantes que no son propios.");

        /// <summary>
        ///     5002 = Se han agotado las solicitudes de por vida
        /// </summary>
        public static readonly CodigoEstatusSolicitud _5002 = new("5002", 5002, "Se han agotado las solicitudes de por vida",
            "Se ha alcanzado el límite de solicitudes, con el mismo criterio.");

        /// <summary>
        ///     5003 = Se han agotado las solicitudes de por vida
        /// </summary>
        public static readonly CodigoEstatusSolicitud _5003 = new("5003", 5003, "Tope máximo",
        ...
        /// </summary>
        public static readonly CodigoEstatusSolicitud _5004 = new("5004", 5004, "No se encontró la información",
            "No se encontró la información del paquete solicitado");

        /// <summary>
        ///     5005 = Ya se tiene una solicitud registrada
        /// </summary>
        public static readonly CodigoEstatusSolicitud _5005 = new("5005", 5005, "Ya se tiene una solicitud registrada",
        ...
        /// </summary>
        public static readonly CodigoEstatusSolicitud _5007 = new("5007", 5007, "No existe el paquete solicitado",
