...
namespace ARSoftware.Cfdi.DescargaMasiva.Enumerations
{
    ...
    public sealed class CodigoEstadoSolicitud : SmartEnum<CodigoEstadoSolicitud>
    {
        ...
        /// </summary>
        public static readonly CodigoEstadoSolicitud _5000 = new("5000", 5000, "Solicitud recibida con éxito",
            "Indica que la solicitud de descarga que se está verificando fue aceptada.");

        /// <summary>
        ///     5002 = Se agotó las solicitudes de por vida.
        /// </summary>
        public static readonly CodigoEstadoSolicitud _5002 = new("5002", 5002, "Se agotó las solicitudes de por vida",
        ...
        ///     5003 = Tope máximo.
        /// </summary>
        public static readonly CodigoEstadoSolicitud _5003 = new("5003", 5003, "Tope máximo",
        ...
        /// </summary>
        public static readonly CodigoEstadoSolicitud _5004 = new("5004", 5004, "No se encontró la información",
        ...
        /// </summary>
        public static readonly CodigoEstadoSolicitud _5005 = new("5005", 5005, "Solicitud duplicada",
        ...
        /// </summary>
        public static readonly CodigoEstadoSolicitud _5011 = new("5011", 5011, "Límite de descargas por folio por día",
            "Se ha alcanzado o sobrepasado el límite de descargas diarias por folio.");

        /// <summary>
        ///     404 = Error no Controlado.
        /// </summary>
        public static readonly CodigoEstadoSolicitud _404 = new("404", 404, "Error no Controlado",
